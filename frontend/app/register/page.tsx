      ...
      <div className="min-h-screen bg-[#F2F4F8] pt-[72px] md:pt-20 overflow-x-hidden">
        <div className="w-full px-4 md:px-6 lg:px-8 xl:px-12 py-12 md:py-20">
          <div className="max-w-md mx-auto text-center">
            <div className="bg-[#FFFDF5] rounded-2xl p-8 border border-[#E8B830]/20">
              <div className="w-16 h-16 bg-[#E8B830]/10 rounded-full flex items-center justify-center mx-auto mb-6 border border-[#E8B830]/20">
                <Mail className="w-8 h-8 text-[#E8B830]" />
              </div>
              <h1 className="text-2xl font-bold text-gray-900 mb-3">Check Your Email</h1>
              <p className="text-gray-600 mb-6 leading-relaxed">
                We've sent a confirmation link to <span className="font-semibold text-[#1A4FAD]">{email}</span>. Click the link to activate your account.
              </p>
              <Link
                href="/login"
                className="inline-flex items-center gap-2 px-6 py-3 bg-[#1A4FAD] text-white rounded-full font-semibold text-sm hover:bg-[#163E8A] transition-colors"
              >
          ...
          <div className="max-w-md mx-auto">
            <div className="bg-[#FFFDF5] rounded-2xl p-6 sm:p-8 border border-[#E8B830]/20 animate-[fadeInUp_0.6s_ease-out_0.2s_both]">
              ...
              <p className="text-center mt-6 text-sm text-gray-500">
                ...
                <Link href="/login" className="text-[#1A4FAD] font-semibold hover:text-[#E8B830] transition-colors">
                  Sign In
                </Link>
              </p>
            </div>
