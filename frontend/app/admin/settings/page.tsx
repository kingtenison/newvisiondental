        ...
        <div className="w-full px-4 sm:px-6 lg:px-12">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            {[
              ...
              <div key={item.label} className="bg-gray-50 rounded-xl p-6 border border-[#1A4FAD]/10 hover:border-[#1A4FAD]/25 hover:shadow-md transition-all group">
                <div className="w-12 h-12 bg-[#E8B830]/10 rounded-xl flex items-center justify-center mb-4 group-hover:bg-[#E8B830]/20 transition-colors">
                  <item.icon className="w-6 h-6 text-[#E8B830]" />
                </div>
                <h3 className="font-bold text-[#1A4FAD] mb-1">{item.label}</h3>
