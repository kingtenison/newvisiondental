        ...
        <div className="w-full px-4 sm:px-6 lg:px-12">
          <div className="relative max-w-md mb-6">
            ...
            <input
              ...
              className="w-full pl-9 pr-4 py-2.5 border-2 border-[#1A4FAD]/15 bg-white rounded-lg focus:outline-none focus:ring-2 focus:ring-[#1A4FAD]/15 focus:border-[#1A4FAD]/40 text-sm"
            />
          </div>
          ...
          <div className="bg-gray-50 rounded-xl overflow-hidden border border-[#1A4FAD]/10">
                    ...
                    <tr key={user.id} className="hover:bg-white transition">
                      <td className="px-5 py-3.5">
                        <div className="flex items-center gap-3">
                          <div className="w-8 h-8 bg-[#E8B830]/10 rounded-full flex items-center justify-center">
                            <Users className="w-4 h-4 text-[#E8B830]" />
                          </div>
                          <span className="text-sm font-medium text-[#1A4FAD]">
                      ...
                      <td className="px-5 py-3.5">
                        <p className="text-sm text-gray-600 flex items-center gap-1">
                          <Mail className="w-3 h-3 text-[#E8B830]/50" /> {user.email || "—"}
                        </p>
                        {user.phone && (
                          <p className="text-xs text-gray-500 flex items-center gap-1 mt-0.5">
                            <Phone className="w-3 h-3 text-[#E8B830]/50" /> {user.phone}
                          </p>
                        )}
                      </td>
            ...
            {filteredUsers.length === 0 && (
              <div className="text-center py-12">
                <Users className="w-12 h-12 text-[#E8B830]/20 mx-auto mb-3" />
