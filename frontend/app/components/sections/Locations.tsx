  ...
  return (
    <section className="py-24 bg-[#050505]">
      <div className="container mx-auto px-6 grid md:grid-cols-2 gap-16 items-center">
        <div>
          <h2 className="text-4xl font-black tracking-tighter text-white uppercase mb-6">Find Us in <br/><span className="text-[#E8B830]">Accra, Ghana</span></h2>
          ...
          <div className="space-y-4">
            ...
            <p className="text-white font-black text-xs tracking-widest uppercase">Mon - Sat: 08:30 - 17:00</p>
          </div>
        </div>
