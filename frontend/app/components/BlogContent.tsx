                    ...
                    <div className="group relative bg-white rounded-3xl border border-[#D4AF37]/15 overflow-hidden hover:shadow-xl hover:shadow-[#D4AF37]/8 hover:border-[#D4AF37]/30 transition-all duration-500">
                      <div className="grid md:grid-cols-2 gap-0">
                        ...
                        <div className="p-8 md:p-10 flex flex-col justify-center">
                          ...
                          <h2 className="text-2xl sm:text-3xl font-bold text-[#5C0F22] mb-4 group-hover:text-[#D4AF37] transition-colors duration-300 leading-tight">
                            {featuredPost.title}
                          </h2>
                          ...
                          <div className="flex items-center gap-5 text-xs text-gray-500 mb-6">
                            <div className="flex items-center gap-1.5">
                              <User className="w-3.5 h-3.5 text-[#D4AF37]/60" />
                          ...
                          <div className="inline-flex items-center gap-2 text-[#5C0F22] font-semibold text-sm group-hover:gap-3 transition-all">
                        ...
                        <div className="group bg-white rounded-2xl border border-[#D4AF37]/10 overflow-hidden hover:shadow-lg hover:shadow-[#D4AF37]/6 hover:border-[#D4AF37]/25 transition-all duration-300 h-full flex flex-col">
                          ...
                          <div className="relative h-56 w-full overflow-hidden">
                            {post.featured_image ? (
                              ...
                              <div className="w-full h-full bg-gradient-to-br from-[#5C0F22]/5 via-[#D4AF37]/5 to-[#5C0F22]/5 flex items-center justify-center">
                                <BookOpen className="w-10 h-10 text-[#D4AF37]/20" />
                              </div>
                            )}
                            <div className="absolute inset-0 bg-gradient-to-t from-black/40 via-black/10 to-transparent" />
                            {post.read_time && (
                              <div className="absolute top-3 right-3 flex items-center gap-1 bg-white/90 backdrop-blur-sm text-[#5C0F22] text-[10px] font-semibold px-2.5 py-1 rounded-full">
                            ...
                            {post.tags && post.tags.length > 0 && (
                              <div className="absolute bottom-3 left-3 flex flex-wrap gap-1.5">
                                {post.tags.slice(0, 2).map((tag: string) => (
                                  <span key={tag} className="text-[10px] px-2 py-0.5 bg-white/90 backdrop-blur-sm text-[#5C0F22] rounded-full font-medium">{tag}</span>
                                ))}
                              </div>
                            )}
                          </div>
                          ...
                          <div className="p-6 flex-1 flex flex-col">
                            ...
                            <div className="mt-auto flex items-center justify-between pt-3 border-t border-gray-100">
                              <div className="flex items-center gap-1.5">
                                <BookOpen className="w-3.5 h-3.5 text-[#D4AF37]/50" />
                                <span className="text-xs text-gray-500">{post.read_time || '5 min read'}</span>
                              </div>
                              <span className="inline-flex items-center gap-1 text-[#5C0F22] text-xs font-semibold group-hover:gap-2 transition-all">
