        ...
        <div className="w-full px-4 sm:px-6 lg:px-12">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
            {statCards.map((stat, i) => (
              <div
                key={i}
                className="bg-white rounded-xl p-5 border border-[#E8B830]/15 hover:border-[#E8B830]/30 hover:shadow-md transition-all animate-[fadeInUp_0.5s_ease-out_both]"
                style={{ animationDelay: `${i * 100}ms` }}
              >
                <div className="flex items-center justify-between mb-3">
                  <div className="w-10 h-10 bg-[#E8B830]/10 rounded-lg flex items-center justify-center">
                    <stat.icon className="w-5 h-5 text-[#E8B830]" />
                  </div>
                  <span className="text-2xl font-bold text-[#1A4FAD]">{stat.value}</span>
                </div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-7 gap-3">
            {quickActions.map((action) => (
              <Link
                key={action.href}
                href={action.href}
                className="bg-white rounded-xl p-4 text-center border border-[#E8B830]/15 hover:shadow-md hover:border-[#E8B830]/30 hover:-translate-y-0.5 transition-all duration-300 group"
              >
                <div className="w-10 h-10 bg-[#E8B830]/10 rounded-lg flex items-center justify-center mx-auto mb-2 group-hover:bg-[#E8B830]/20 transition-colors">
                  <action.icon className="w-5 h-5 text-[#E8B830]" />
                </div>
      ...
      <section className="w-full py-8 bg-[#FFFDF5]">
        <div className="w-full px-4 sm:px-6 lg:px-12">
          <div className="flex justify-between items-center mb-4">
            ...
            <Link href="/admin/appointments" className="text-[#1A4FAD] hover:text-[#E8B830] text-sm font-medium flex items-center gap-1 transition-colors">
